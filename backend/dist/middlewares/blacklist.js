...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let hashedIp = hashing_1.md5.hash(req.ip);
    let blacklisted = (yield database_1.default.query("SELECT * FROM blacklist WHERE ip = ?", [hashedIp]))[0];
    if (blacklisted.length > 0 && (req.path === '/blacklisted' || req.path === '/blacklisted/'))
        res.send(`
        <head>
            <style>
